...
<div class="container-fluid page__container page-section">
    <?php echo form_open('edit-customer-'.$user->user_id, ['method' => 'post']) ?>
        ...
        <div class="flex" style="max-width: 100%">
               ...
               <div class="form-row">
                  <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" value="<?php echo ( $this->input->post('username') ? $this->input->post('username') : $user->email) ?>" class="form-control" id="validationSample01" disabled>
               ...
               <div class="form-row">
                  <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" name="companyName" value="<?php echo ($this->input->post('companyName') ? $this->input->post('companyName') : $user->customer_company )?>" class="form-control" id="validationSample06" placeholder="Enter a company name" >
               ...
               <div class="form-row">
                  <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" name="gst_no" value="<?php echo ($this->input->post('gst_no') ? $this->input->post('gst_no') : $user->gstn )?>" class="form-control" id="validationSample08" placeholder="Enter gst no." >
                        <div class="invalid-feedback">Please provide a company name.</div>
                        <div class="valid-feedback">Looks good!</div>
               ...
               <div class="form-row">
                  <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" name="plotFactoryNo" value="<?php echo ($this->input->post('plotFactoryNo') ? $this->input->post('plotFactoryNo') : $user->plot_factory_no )?>" class="form-control" id="validationSample09" placeholder="Enter plot/factory no." >
               ...
               <div class="form-row">
                  <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" name="fullAddress" value="<?php echo ($this->input->post('fullAddress') ? $this->input->post('fullAddress') : $user->complete_address )?>" class="form-control" id="validationSample10" placeholder="Enter complete address." >
               ...
               <div class="form-row">
                  <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" name="landmark" value="<?php echo ($this->input->post('landmark') ? $this->input->post('landmark') : $user->landmark )?>" class="form-control" id="validationSample11" placeholder="Enter a landmark." >
               ...
               <div class="form-row">
                  <div class="col-12 col-md-6 mb-3">
                     ...
                     <select id="select01"
                        ...
                        <?php
                           foreach ($state as $s) {
                              $selected = ($s['state_id'] == $user->state_id) ? ' selected="selected"' : "";
