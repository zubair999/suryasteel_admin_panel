...
<div class="container-fluid page__container page-section">
   <?php echo form_open('add-subcategorytype', ['method' => 'post']) ?>
            ...
            <div class="was-validated">
                     ...
                     <div class="alert bg-success text-white border-0" role="alert">
                        <div class="d-flex flex-wrap align-items-start">
                           ...
                           <div class="flex" style="min-width: 180px">
                              <small>
                                 <strong></strong> <?php echo $this->session->flashdata('notification') ?>
                              </small>
                           </div>
                        </div>
                     </div>
               ...
               <div class="form-row">
                  <div class="col-12 col-md-6 mb-3">
                     <label class="form-label" for="validationSample01">Select Sub Category Parent</label>
                     <!-- <input type="text" name="category" class="form-control" id="validationSample01" placeholder="Enter category title" required> -->
                     <select name="parent" class="form-control">
                        <option value="">Select Category</option>
                        <?php
                        foreach ($main_categories as $each) { ?>
                        <option value="<?php echo $each['sub_category_id']; ?>"><?php echo $each['sub_category_name']; ?></option>';
                        <?php }
                        ?>
                     </select>
               ...
               <!-- <div class="form-row">
                    ...
                    <div class="col-12 col-md-6 mb-3" >
                        <image
                           id="showImg"
                           style="width: 75px;height: 75px;border: 1px solid #ddd;padding: 5px;display:none"
                           src=""
                        />
               ...
               <!-- <input hidden type="text"  id="thumbId" name="thumbnail_id" class="form-control"> -->
