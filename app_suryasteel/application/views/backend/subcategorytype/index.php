...
<div class="container-fluid page__container page-section">
   <div class="page-separator">
      <div class="page-separator__text"><a class="btn btn-primary" href="<?php echo base_url('add-subcategorytype'); ?>">Add</a></div>
      <!-- <div class="page-separator__text"><a class="btn btn-primary" href="<?php echo base_url('add/subcategorytype'); ?>">Sub Categories</a></div> -->
   </div>
            ...
            ?>
               ...
               <div class="card card-sm card-group-row__card">
                  ...
                  <div class="card-body d-flex">
                     ...
                     <div class="flex">
                        <h5 class="card-title m-0"><a href=""><?php echo $c['sub_category_type_name'] ?></a></h5>
                        ...
                        <small class="text-muted"><a href="<?php echo base_url('subcategorytype-'.$c['sub_category_type_id']) ?>"> </a></small>
                  ...
                  <div class="d-flex m-2">
                     <div class="flex">
                        <a href="<?php echo base_url('edit-subcategorytype-'.$c['sub_category_type_id']); ?>">
                           <button type="button" class="btn btn-outline-primary">
                              <i class="material-icons icon--left">build</i> Edit
                           </button>
                        <a href="<?php echo base_url('edit-subcateogorytype-'.$c['sub_category_type_id']); ?>">
                     </div>
                     <div>
