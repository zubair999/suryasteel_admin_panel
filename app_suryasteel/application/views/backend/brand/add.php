...
<div class="container-fluid page__container page-section">
    <?php echo form_open('add-brand', ['method' => 'post']) ?>
            ...
            <div class="was-validated">
               <div class="form-row">
                  ...
                  <div class="col-12 col-md-6 mb-3">
                     <label class="form-label" for="validationSample01">Brand Name</label>
                     <input type="text" name="brand_name" value="<?php echo ($this->input->post('brand_name') ? $this->input->post('brand_name') : null) ?>" class="form-control" id="validationSample01" placeholder="Enter category title" required>
